...
func (uq *UserQuery) QueryAttempts() *ExamAttemptQuery {
	query := (&ExamAttemptClient{config: uq.config}).Query()
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withAttempts: uq.withAttempts.Clone(),
...
func (uq *UserQuery) WithAttempts(opts ...func(*ExamAttemptQuery)) *UserQuery {
	query := (&ExamAttemptClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withAttempts = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withAttempts; query != nil {
		if err := uq.loadAttempts(ctx, query, nodes,
			func(n *User) { n.Edges.Attempts = []*ExamAttempt{} },
			func(n *User, e *ExamAttempt) { n.Edges.Attempts = append(n.Edges.Attempts, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadAttempts(ctx context.Context, query *ExamAttemptQuery, nodes []*User, init func(*User), assign func(*User, *ExamAttempt)) error {
