...
const (
	// Label holds the string label denoting the examgroup type in the database.
	Label = "exam_group"
...
// OrderOption defines the ordering options for the ExamGroup queries.
